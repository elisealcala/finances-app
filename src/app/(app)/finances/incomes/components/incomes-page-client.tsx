...
import {
  useIncomes,
  useDeleteIncome,
  useIncomeCategorySummary,
} from "@/hooks/use-incomes";
import { usePeriodFilter } from "../../hooks/use-period-filter";
import { PeriodSelector } from "../../components/period-selector";
import { IncomeTable } from "./income-table";
import { IncomeForm } from "./income-form";
import { IncomeCategorySummaryCard } from "./income-category-summary-card";
...
export function IncomesPageClient() {
  ...
  const { data: categorySummary, isLoading: categorySummaryLoading } =
    useIncomeCategorySummary({ accountId });
  ...
  return (
    <div className="space-y-6">
      ...
      <IncomeCategorySummaryCard
        rows={categorySummary?.rows}
        totalsByCurrency={categorySummary?.totalsByCurrency}

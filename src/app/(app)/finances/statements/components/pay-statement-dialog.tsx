...
export function PayStatementDialog({
  ...
  }, [statementCurrency, unpaidExpenses]);
                ...
                <div className="grid gap-2">
                  {groups.map((group) => {
                    const needsConversion =
                      group.currency !== group.payingAccountCurrency;
                    const displayedRate = needsConversion
                      ? parseFloat(rates[rateKey(group)] ?? "")
                      : 1;
                    const rateBasis = getCurrencyConversionRateBasis(
                      group.currency,
                      group.payingAccountCurrency,
